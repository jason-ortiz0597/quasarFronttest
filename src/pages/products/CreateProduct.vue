        ...
        <div class="col-8">
            ...
            <div class="q-pa-none">
                <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md" v-if="editar">
                    <q-input v-model="nombre" type="text" label="Nombre Del Producto" filled />
                    <q-input v-model="descripcion" type="text" label="Descripcion Del Producto" filled />
                    <q-select v-model="categoria"  label="seleccione una categoria" filled use-input  hide-selected >
